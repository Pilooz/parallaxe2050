...
module.exports = function(io, rfid, arduino1, arduino2, scenario, eventArduinoMsg, logger) {
    ...
    function treat_message(msg) {
        ...
        // If qui fix le pin noir qui renvoie "0" au bout d'un moment sur le girlduino pour éviter d'avoir à refaire une intervention dans le container
        // On reçoit msg.val = [ {"red": 1}, {"black": 1}, {"yellow": 1}, {"white": 1}, {"green": 1} ]
        // if (msg.key == "VALUES") {
        //     var isSolutionOk = true;
        //     for (var i = msg.val.length - 1; i >= 0; i--) {
        //         if(msg.val[i].hasOwnProperty("red") && msg.val[i].red == 0) {
        //             isSolutionOk = false;
        //         }
        //         // if(msg.val[i].hasOwnProperty("black") && msg.val[i].black == 0) {
        //         //     isSolutionOk = false;
        //         // }
        //         if(msg.val[i].hasOwnProperty("yellow") && msg.val[i].yellow == 0) {
        //             isSolutionOk = false;
        //         }
        //         if(msg.val[i].hasOwnProperty("white") && msg.val[i].white == 0) {
        //             isSolutionOk = false;
        //         }
        //         if(msg.val[i].hasOwnProperty("green") && msg.val[i].green == 0) {
        //             isSolutionOk = false;
        //         }
        //     };
        ...
        //     // Après un délai, on envoi l'info comme quoi le robot a terminé
        //     setTimeout(function() {
