...
module.exports = function(global_config, io, eventEmitter, logger) {
    ...
    function initCount() {
        var msg = "   l___ ";
        // Si le timer a été sauvé. ré-init à partir de la sauvegarde
...
// 
// Controlling timer
eventEmitter.on('toserver.killTimer', function() {
...
timerIO.on('connection', function(sock){
    ...
    // Init the timer, when loading this library
    initCount();
