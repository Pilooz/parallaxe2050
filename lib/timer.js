...
module.exports = function(io, eventEmitter, logger) {
    ...
    const INTERVALL = 990;  // Interval of setTimeout, compensed by execution time

    var _totalTime = 100;  // Temps de jeu total en sec. Par defaut, c'est le mode classe entière
    var _timeElapsed = 0;
