...
module.exports = function(io, rfid, arduino, scenario, eventEmitter) {
    ...
    var launchpad        = require('./launchpad.js')(eventEmitter);
    var socks = null;
    ...
    function handle_solution(studentResp) {
        ...
        console.log("right responses   : " + JSON.stringify(soluces[0].responses));
        console.log("Student responses : " + JSON.stringify(studentResp));
        // Analysing responses
